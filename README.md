...
<p align="center">
<img src="https://skillicons.dev/icons?i=python,java,cpp,c,js,html,css,react,nodejs,fastapi,flask,git,github,docker,mysql,postgres,mongodb,vscode,linux" />
</p>
...
<table>
  <tr>
    <td>🧠</td>
    <td><b><a href="https://github.com/adityasolanki192004-dot/Adaptive-Rag">Adaptive RAG — Agentic AI Chatbot</a></b><br/>
      End-to-end Retrieval-Augmented Generation system with LangGraph-based agentic routing. Dynamically classifies queries and answers from indexed documents, general LLM knowledge, or live web search, with Qdrant vector retrieval, MongoDB-backed chat memory, a FastAPI backend, and a Streamlit chat UI.<br/>
      <sub><b>Stack:</b> Python · FastAPI · LangGraph · Qdrant · MongoDB · Streamlit · OpenAI</sub>
    </td>
  </tr>
  <tr>
    <td>🤖</td>
    <td><b>AI Code Review Assistant</b><br/>AI-powered code reviewer built with FastAPI & an LLM backend.<br/>
      <sub><b>Stack:</b> Python · FastAPI · LLM</sub>
    </td>
  </tr>
  <tr>
    <td>🛡️</td>
    <td><b>SafeRouteAI</b><br/>Intelligent route safety prediction system.<br/>
      <sub><b>Stack:</b> Python · ML</sub>
    </td>
  </tr>
  <tr>
    <td>📄</td>
    <td><b>Smart Resume Analyzer</b><br/>ATS-style resume analysis powered by AI.<br/>
      <sub><b>Stack:</b> Python · AI</sub>
    </td>
  </tr>
  <tr>
    <td>🎓</td>
    <td><b>Student Success Analyzer</b><br/>ML-based prediction of student performance.<br/>
      <sub><b>Stack:</b> Python · Machine Learning</sub>
    </td>
  </tr>
  <tr>
    <td>📱</td>
    <td><b>QR Attendance System</b><br/>Attendance tracking with QR codes.<br/>
      <sub><b>Stack:</b> Flask · QR Code</sub>
    </td>
  </tr>
  <tr>
    <td>🍔</td>
    <td><b>Smart Canteen</b><br/>Online food ordering platform.<br/>
      <sub><b>Stack:</b> Full Stack Web</sub>
    </td>
  </tr>
</table>
